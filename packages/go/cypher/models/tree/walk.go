...
func NewCancelableErrorHandler(panicOnErr bool) CancelableErrorHandler {
...
func NewComposableHierarchicalVisitor[E any](panicOnErr bool) HierarchicalVisitor[E] {
	return composableHierarchicalVisitor[E]{
		CancelableErrorHandler: NewCancelableErrorHandler(panicOnErr),
	}
}
...
func NewSimpleVisitor[N any](visitorFunc SimpleVisitorFunc[N]) HierarchicalVisitor[N] {
	return &simpleVisitor[N]{
		HierarchicalVisitor: NewComposableHierarchicalVisitor[N](false),
...
func NewOrderedVisitors[N any](panicOnError bool, visitors ...HierarchicalVisitor[N]) HierarchicalVisitor[N] {
...
func WalkPgSQL(node pgsql.SyntaxNode, visitors ...HierarchicalVisitor[pgsql.SyntaxNode]) error {
	...
	return Generic(node, NewOrderedVisitors[pgsql.SyntaxNode](true, visitors...), newSQLWalkCursor)
}
...
func WalkCypher(node cypher.SyntaxNode, visitors ...HierarchicalVisitor[cypher.SyntaxNode]) error {
	...
	return Generic(node, NewOrderedVisitors[cypher.SyntaxNode](false, visitors...), newCypherWalkCursor)
}
