...
func newCypherWalkCursor(node cypher.SyntaxNode) (*Cursor[cypher.SyntaxNode], error) {
	...
	case *cypher.RangeQuantifier, *cypher.PropertyLookup, cypher.Operator, *cypher.Properties, *cypher.KindMatcher,
	...
	case *cypher.Literal:
		...
		case *cypher.ListLiteral:
			return &Cursor[cypher.SyntaxNode]{
				Node:     typedValue,
				Branches: pgsql.MustSliceTypeConvert[cypher.SyntaxNode](typedValue.Expressions()),
			}, nil
